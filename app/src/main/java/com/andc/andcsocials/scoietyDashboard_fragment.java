...
public class scoietyDashboard_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
          View v = inflater.inflate(R.layout.fragment_scoiety_dashboard_fragment, container, false);
          return v;
    }
...
//
//        tabLayout = (TabLayout) getView().findViewById(R.id.tabSociety_dashboard);
//        pager2 = (ViewPager2) getView().findViewById(R.id.view_pager_dashboard);
//
//        editProfile_dashboard_asTempoaryLogOut=   getView().findViewById(R.id.editProfile_dashboard);
//
